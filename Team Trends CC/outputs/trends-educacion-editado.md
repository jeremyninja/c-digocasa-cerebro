# EDUCACIÓN — TREND FORECAST

**Slug:** trends-educacion
**Fecha:** 2026-05-27
**Estructura:** 3 macros + 15 micros (5 por macro)
**Filosofía:** perspectiva global/LATAM contrastando con el estudio Código Casa. Afirmaciones RD solo con doble prueba (stat externa RD + evidencia TikTok/medio dominicano).

---

## Apertura del forecast

El guion viejo decía: secundaria, título, empleo, estabilidad. En ese orden, sin saltos. Pero el mundo cambió la regla del juego mientras nosotros seguíamos midiendo el aula. Hoy más de la mitad de los empleadores globales contrata por habilidades, el estudiante busca en TikTok antes que en Google, y el tutor que resuelve la duda a las 2am es un modelo de IA, no un profesor. Código Casa funciona aquí como espejo: el dominicano todavía debate si la universidad pública es buena [P44, P46], mientras del otro lado del espejo la pregunta ya es otra — si la universidad sigue siendo necesaria. Tres lentes para leer ese desfase: la adultez que se reinventa, el hogar prompteado, y el feed que se volvió la primera aula.
...
### The transformation
En 3-5 años el currículum dominicano va a competir con stacks de microcredenciales que un joven arma desde el celular sin pisar un aula.

### Ask yourself
¿Tu marca certifica el diploma viejo, o ayuda al dominicano a construir el portafolio de habilidades que el mercado sí está mirando?

### Pruebas
- **Prueba TikTok:** [link](https://www.tiktok.com/tag/skillsnotdegrees) → grid del trend skills vs título
  - `screenshots/trends-educacion/macro-1-1-tiktok-skillsnotdegrees.png`
- **Trend:** [link](https://accelerec.com/the-4-year-degree-is-dead-why-skills-based-hiring-is-taking-over-in-2025/) → "The 4-Year Degree Is Dead", el skills-based hiring como default
  - `screenshots/trends-educacion/macro-1-0-accelerec-skills-hiring.png`
- **Innovación:** [link](https://grow.google/certificates/) → Google Career Certificates, badges para roles tech sin título
  - `screenshots/trends-educacion/macro-2-4-coursera-google-cert.png`
...
### The contrast
Aquí el espejo pega duro. 64.8% del país cree que el dominicano es poco o medianamente competitivo [Código Casa P47]. O sea: ni el que tiene el título confía del todo en lo que el título promete. Esa duda es la grieta por donde, afuera, entra el path sin diploma.

### Pruebas
- **TikTok:** [link](https://www.tiktok.com/tag/skillsnotdegrees) → grid del hashtag, skills vs título
  - `screenshots/trends-educacion/macro-1-1-tiktok-skillsnotdegrees.png`
- **Trend:** [link](https://blog.theinterviewguys.com/the-state-of-skills-based-hiring/) → State of Skills-Based Hiring 2025, la paradoja 85% vs 1/700
  - `screenshots/trends-educacion/macro-1-1-interviewguys-skills-hiring-2025.png`
- **Innovación:** [link](https://accelerec.com/the-4-year-degree-is-dead-why-skills-based-hiring-is-taking-over-in-2025/) → editorial del 4-year degree muerto
  - `screenshots/trends-educacion/macro-1-0-accelerec-skills-hiring.png`

### 3 Needs
`EMPLEABILIDAD` · `MIEDO` · `VALIDACIÓN`
...
### The contrast
Código Casa muestra a un país que todavía pone "uso de tecnología" como una carencia del aula formal [P46]. El sistema se evalúa por lo que le falta. Afuera, el adulto dejó de esperar que el sistema lo actualice — se actualiza él, por su cuenta, cada par de años.

### Pruebas
- **TikTok:** [link](https://www.coursera.org/skills-reports/global) → badge del Coursera Global Skills Report, el upskilling LATAM en números
  - `screenshots/trends-educacion/macro-1-2-coursera-global-skills-report.png`
- **Trend:** [link](https://www.weforum.org/stories/2025/01/future-of-jobs-report-2025-jobs-of-the-future-and-the-skills-you-need-to-get-them/) → WEF "Great Skills Reset", 39% de skills cambian
  - `screenshots/trends-educacion/macro-1-2-wef-future-of-jobs.png`
- **Innovación:** [link](https://www.coursera.org/skills-reports/global) → Coursera, el reporte de skills como producto
  - `screenshots/trends-educacion/macro-1-2-coursera-global-skills-report.png`

### 3 Needs
`VIGENCIA` · `MIEDO` · `AUTONOMÍA`

---

## 1.3 — Familias globales sacan a sus hijos del colegio por elección, no por crisis: el aula de 30 compite con microschools de 5-15 y currículos a la medida.

### El fenómeno
El homeschool dejó de ser cosa de nicho. Creció 4.9% en 2024-25, casi 3x la tasa pre-pandemia, y 36% de los estados de EEUU reportó máximos históricos. En paralelo aparecen las microschools — hubs de 5 a 15 alumnos, promedio 22, donde la familia diseña el currículo. Entre 1 y 2 millones de estudiantes ya asisten full-time. La motivación no es la fuga de un sistema en llamas. Es el control: la familia quiere armar la educación, no delegarla.

### Data y señales
- `[GLOBAL] [ESTUDIO]` El homeschool creció 4.9% en 2024-25, casi 3x la tasa pre-pandemia; 36% de los estados con máximos históricos. — *JHU Institute for Education Policy · 2025*
- `[GLOBAL] [INDUSTRIA]` Entre 1 y 2 millones de estudiantes en EEUU ya asisten a microschools full-time, promedio 22 alumnos. — *RAND / National Microschooling Center · 2025*
- `[GLOBAL] [NOTICIA]` "Microschools on the rise, offer families a flexible alternative." — *CBS Miami · 2025*

**Hashtags:** `#homeschool · #microschool · #unschooling · #homeschoollife · #educacionalternativa`

### The contrast
RD sigue midiendo la escuela por sus insumos — infraestructura, materiales, calidad docente [P46]. La conversación es cómo arreglar el aula. Afuera ya hay familias que decidieron no usar el aula. Distinto problema, distinto juego.

### Pruebas
- **TikTok:** [link](https://www.cbsnews.com/miami/news/microschools-families-flexible-alternative/) → hub de aprendizaje alternativo en Florida
  - `screenshots/trends-educacion/macro-1-3-cbsmiami-microschools.png`
- **Trend:** [link](https://education.jhu.edu/edpolicy/policy-research-initiatives/homeschool-hub/homeschool-growth-2024-2025/) → JHU, crecimiento 4.9% con mapa de estados
  - `screenshots/trends-educacion/macro-1-3-jhu-homeschool-growth.png`
- **Innovación:** [link](https://www.theschoolhouse.org/post/rising-microschools-education) → "Why Microschools Are Rising", el grupo pequeño como modelo
  - `screenshots/trends-educacion/macro-1-3-theschoolhouse-microschools.png`

### 3 Needs
`CONTROL` · `PERTENENCIA` · `RESENTIMIENTO`

---

## 1.4 — El "siguiente paso obvio" tras el bachillerato dejó de ser obvio: gap year, bootcamp y emprendimiento adolescente sustituyen el ingreso inmediato a la universidad.

### El fenómeno
Terminabas el bachillerato y entrabas a la universidad. Punto. Eso ya no es el default. Solo 18% de Gen Z global ve subir la escalera corporativa como algo inteligente — el camino lineal perdió prestigio. Y Big Tech lo validó: Google, IBM y Tesla quitaron el título para muchos roles. Entonces el recién graduado se da un año, hace un bootcamp, o monta un ingreso con skills digitales antes de comprometerse a una carrera cara. No es vagancia. Es calcular el costo antes de firmar.
...
### The contrast
Código Casa muestra un país donde 34.4% ve la universidad "muy accesible" y el acceso universitario es tema de orgullo [P45]. El logro es entrar. Afuera el logro empezó a ser otro: no entrar todavía, y a propósito.
...
### The contrast
RD califica la educación pública con dureza — 26% la llama "muy mala" [P46]. Pero la desconfianza no se queda en la queja. Donde hay plata para refuerzo, la familia lo paga; donde no la hay, el hueco se queda abierto. La brecha de aprendizaje también es una brecha de bolsillo.
...
### Ask yourself
¿Tu marca aparece en el momento en que el dominicano aprende con IA, o sigue compitiendo por el espacio del aula física que ya perdió relevancia?
...
### The contrast
RD califica la educación pública con dureza [P46] y al mismo tiempo desconfía del nivel competitivo del país [P47]. Ese es exactamente el vacío que un tutor AI low-cost llena afuera: no espera que el sistema mejore, lo bypassea.

### Pruebas
- **TikTok:** [link](https://www.tiktok.com/tag/studytok) → "AI helped me pass", testimonios de estudio con IA
  - `screenshots/trends-educacion/macro-3-0-tiktok-studytok-tag.png`
- **Trend:** [link](https://www.globalsociety.earth/post/khan-academy-rolls-out-ai-powered-teaching-tools-as-school-districts-scale-up-adoption) → Khanmigo escala en distritos escolares
  - `screenshots/trends-educacion/macro-2-1-globalsociety-khanmigo-ai-tools.png`
- **Innovación:** [link](https://khanmigo.ai/) → Khanmigo, UI del tutor AI siempre disponible
  - `screenshots/trends-educacion/macro-2-1-khanmigo-hero-landing.png`

### 3 Needs
`EQUIDAD` · `SUPLIR` · `RESENTIMIENTO`
...
### The contrast
En el espejo, el país discute infraestructura y calidad docente [P46]. Mientras tanto, lo que sostiene el aprendizaje diario afuera no es el aula ni el profesor — es una mecánica de juego que te hace sentir culpa si fallas un día.
...
### The contrast
RD pide más tecnología en el aula formal [P46]. Pero la tecnología que más usa el estudiante no es la que el ministerio aprueba — es la que esquiva al profesor. El aula pide IA por la puerta del frente mientras el estudiante ya la metió por la de atrás.
...
### The contrast
RD pone el acceso universitario como tema de orgullo [P45] — entrar a la universidad es el logro. Afuera, el logro empezó a ser portátil: un badge que pesa en una entrevista sin pedir cuatro años de tu vida.

### Pruebas
- **TikTok:** [link](https://grow.google/certificates/) → Google Career Certificates, badge sin título
  - `screenshots/trends-educacion/macro-2-4-coursera-google-cert.png`
- **Trend:** [link](https://fortune.com/2025/12/28/2026-microcredential-hiring-trend-coursera-greg-hart/) → Fortune, "hired in 2026 = microcredentials"
  - `screenshots/trends-educacion/macro-2-4-fortune-microcredentials.png`
- **Innovación:** [link](https://www.edsurge.com/news/2024-11-22-how-digital-credentials-can-elevate-existing-programs) → EdSurge, credenciales digitales verificables
  - `screenshots/trends-educacion/macro-2-4-edsurge-digital-credentials.png`

### 3 Needs
`VALIDACIÓN` · `EMPLEABILIDAD` · `MIEDO`
...
### The contrast
Código Casa muestra a un país que evalúa la educación por sus insumos formales — calidad docente, infraestructura, materiales [P46] — mientras el aprendizaje real migra a una plataforma que ninguna de esas categorías nombra. El espejo refleja un país midiendo la escuela vieja mientras el estudiante ya estudia en el feed.

### The transformation
En 3-5 años el orientador vocacional dominicano va a competir con creadores de TikTok que moldean qué carrera escoge un adolescente en 60 segundos.

### Ask yourself
¿Tu marca educativa vive donde el dominicano realmente aprende — en el feed, en formato de 60 segundos — o sigue produciendo contenido formato aula?
...
### The contrast
El país mide la escuela por sus insumos físicos [P46]. Pero lo que sostiene a un estudiante despierto estudiando a las 11pm afuera no es el aula — es saber que hay alguien del otro lado del live mirándolo estudiar. La accountability se externalizó al feed.

### Pruebas
- **TikTok:** [link](https://www.tiktok.com/tag/studytok) → grid #studytok, estudio compartido y notas estéticas
  - `screenshots/trends-educacion/macro-3-0-tiktok-studytok-tag.png`
- **Trend:** [link](https://www.youtube.com/results?search_query=study+with+me+2025) → "study with me 2025", el género en YouTube
  - `screenshots/trends-educacion/macro-3-1-youtube-studywithme.png`
- **Innovación:** [link](https://www.southeastarrow.com/lifestyle/the-rise-of-studytok-is-it-motivational-or-a-distraction-9240f298) → el debate del estudio performativo
  - `screenshots/trends-educacion/macro-3-1-southeastarrow-studytok.png`

### 3 Needs
`PERTENENCIA` · `SOLEDAD` · `VALIDACIÓN`

---

## 3.2 — El feed reemplazó al buscador como puerta del conocimiento: 53% de Gen Z consulta TikTok antes que Google, y qué es "verdad" lo curan creadores, no fuentes.

### El fenómeno
"Búscalo en Google" se volvió "búscalo en TikTok". 53% de Gen Z consulta TikTok, Reddit o YouTube antes que Google para informarse. El comportamiento observable: el estudiante busca la explicación de un tema escolar directo en el feed, en formato de 60 segundos con cara y voz, en vez de leer un artículo. El criterio de qué es verdad ya no lo decide la fuente — lo decide el creador que te cae bien.

### Data y señales
- `[GLOBAL] [ESTUDIO]` 53% de Gen Z busca en TikTok/Reddit/YouTube antes que Google. — *Resolve · 2026*
- `[GLOBAL] [TIKTOK]` Gen Z y Gen Alpha usan el video social como herramienta de búsqueda cotidiana. — *Information Matters · 2026*
- `[GLOBAL] [NOTICIA]` "Why Gen Z turns to YouTube and TikTok for learning." — *Uqualio · 2025*

**Hashtags:** `#learnontiktok · #tiktoktaughtme · #edutok · #tiktokitdontgoogleit · #aprendintiktok`

### The contrast
RD discute calidad docente y materiales [P46] — la fuente del conocimiento es el aula. Afuera, la fuente es quien tenga más views explicando el tema. Y ahí hay algo más pasando: la autoridad del conocimiento se desplazó del que sabe al que comunica bien.

### Pruebas
- **TikTok:** [link](https://www.tiktok.com/tag/studytok) → "things TikTok taught me", el feed como fuente
  - `screenshots/trends-educacion/macro-3-2-informationmatters-genz-tiktok-search.png`
- **Trend:** [link](https://informationmatters.org/2026/03/tiktok-it-dont-google-it-gen-z-gen-alpha-and-the-rise-of-social-video-as-an-everyday-search-tool/) → "TikTok It, Don't Google It", 53% busca social
  - `screenshots/trends-educacion/macro-3-2-informationmatters-genz-tiktok-search.png`
- **Innovación:** [link](https://uqualio.com/post/why-generation-z-turns-to-youtube-and-tiktok-for-learning-the-power-of-video-in-education) → Uqualio, Gen Z y el video como herramienta educativa
  - `screenshots/trends-educacion/macro-3-2-uqualio-genz-video-learning.png`

### 3 Needs
`INMEDIATEZ` · `PERTENENCIA` · `VACÍO`

---

## 3.3 — El conocimiento se fragmentó al formato del feed: el microlearning en píldoras de 60 segundos reemplaza la clase de 50 minutos, y la escuela K-12 ya está adoptándolo.

### El fenómeno
La clase de 50 minutos perdió contra el tramo de atención que el feed entrenó. El microlearning — conceptos en clips cortos — empezó a reemplazar la lectura larga y la clase entera. Lo curioso es que dejó de ser solo cosa de redes: las escuelas K-12 ya están adoptando el formato corto que el algoritmo impuso primero. Una revisión 2025 encontró que el microlearning asistido por TikTok mejora retención y engagement. El estudiante aprende en píldoras porque su atención fue calibrada por el feed.

### Data y señales
- `[GLOBAL] [NOTICIA]` "Bringing microlearning to K-12 schools" — las escuelas adoptan el formato corto. — *NY State School Boards Assoc. · 2025*
- `[GLOBAL] [ESTUDIO]` Revisión 2025: el microlearning asistido por TikTok mejora retención y engagement. — *CTO College · 2026*
- `[GLOBAL] [TIKTOK]` Los formatos "explained in 60 seconds" dominan EduTok. — *TikTok · 2025*

**Hashtags:** `#microlearning · #learnin60seconds · #edutok · #explained · #aprenderrapido`

### The contrast
El país piensa la educación en unidades de aula — horas de clase, calidad docente [P46]. Pero la unidad de aprendizaje afuera ya no es la hora de clase. Es el clip de 60 segundos. Y la escuela formal está corriendo detrás de un formato que el algoritmo ya normalizó.

### Pruebas
- **TikTok:** [link](https://correctionstocollegeca.org/tiktok-and-the-future-of-learning-microlearning-engagement-and-the-2026-classroom-revolution/) → "explained in 60 seconds", el formato del feed
  - `screenshots/trends-educacion/macro-3-3-cto-microlearning.png`
- **Trend:** [link](https://www.nyssba.org/news/2025/08/08/on-board-online-august-11-2025/bringing-microlearning-to-k-12-schools-offers-many-opportunities-challenges/) → NYSSBA, microlearning entra a K-12
  - `screenshots/trends-educacion/macro-3-3-nyssba-microlearning-k12.png`
- **Innovación:** [link](https://www.linkedin.com/learning/) → LinkedIn Learning, cursos bite-sized para profesionales
  - `screenshots/trends-educacion/macro-3-3-linkedin-learning-ui.png`

### 3 Needs
`ATENCIÓN` · `INMEDIATEZ` · `VACÍO`
...
### The contrast
RD mide el acceso universitario como logro [P45] — la pregunta es si puedes entrar. Pero qué carrera escoger, esa decisión ya se está tomando en el feed, viendo a alguien vivir la profesión antes de comprometerse a ella. El orientador compite con un creador de 19 años y mejor edición.

### Pruebas
- **TikTok:** [link](https://www.tiktok.com/tag/careertok) → grid #careertok, "day in my life" y salary reveals
  - `screenshots/trends-educacion/macro-3-4-tiktok-careertok.png`
- **Trend:** [link](https://www.youtube.com/results?search_query=day+in+my+life+career+tiktok+2025) → "day in my life career", el formato vocacional
  - `screenshots/trends-educacion/macro-3-4-youtube-careertok.png`
- **Innovación:** [link](https://www.contentgrip.com/tiktok-trends-gen-z-marketing-guide/) → ContentGrip, career/salary transparency en el trend report
  - `screenshots/trends-educacion/macro-3-4-contentgrip-tiktok-genz.png`

### 3 Needs
`PROYECCIÓN` · `MIEDO` · `AUTONOMÍA`

---

## 3.5 — El feed materno dicta cómo se educa al niño: MomTok recomienda apps, currículos y "guilt-free screen time", y desplazó a la maestra como autoridad pedagógica del hogar.
...
### The contrast
El país piensa la educación del niño como cosa de la escuela [P44, P46]. Pero la decisión de qué app, qué video, qué método aprende un toddler se está tomando en el feed materno — antes de que el niño pise un aula. La autoridad pedagógica del hogar se mudó de la maestra a la creadora.
